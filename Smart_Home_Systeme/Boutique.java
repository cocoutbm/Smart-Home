...
public class Boutique {
    ...
    public Boutique() {
        this.Radiateur1 = new Equipements_energetiques("Radiateur lowcost", 150.0, 100.0);
        this.Radiateur2 = new Equipements_energetiques("Radiateur populaire", 250.0, 150.0);
        this.Radiateur3 = new Equipements_energetiques("Radiateur haut de' gamme", 350.0, 200.0);
        this.Ventilateur1 = new Equipements_energetiques("Ventilateur lowcost", 25.0, 50.0);
        this.Ventilateur2 = new Equipements_energetiques("Ventilateur populaire", 65.0, 100.0);
        this.Ventilateur3 = new Equipements_energetiques("Ventilateur haut de gamme", 100.0, 150.0);
        this.Ampoule1 = new Equipements_energetiques("Ampoule lowcost", 3.5, 10.0);
        this.Ampoule2 = new Equipements_energetiques("Ampoule populaire", 7.5, 20.0);
        this.Ampoule3 = new Equipements_energetiques("Ampoule haut de gamme", 14.5, 30.0);
    }
